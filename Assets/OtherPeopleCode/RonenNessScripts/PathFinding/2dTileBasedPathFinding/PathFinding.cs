...
// Modifications made by Talist. ... What? I'm probably releasing the source code at some point, and I'm not putting my real name on this yet.
// Added ways to calculate movement without 'corner cutting'.
...
namespace NesScripts.Controls.PathFind
{
    ...
    public class Pathfinding
    {
		...
		public enum DistanceType
		{
            ...
            /// <summary>
            /// Same as Euclidean, but can only move diagonally if both cardinal directions and the diagonal are free.
            /// </summary>
            NoCornerCutting
        }
		...
		public static List<Point> FindPath(WalkableTilesGrid grid, Point startPos, Point targetPos, DistanceType distance = DistanceType.Euclidean, bool ignorePrices = false)
        {
            // find path
        ...
        private static List<Node> _ImpFindPath(WalkableTilesGrid grid, Point startPos, Point targetPos, DistanceType distance = DistanceType.Euclidean, bool ignorePrices = false)
        {
        ...
        private static List<Node> RetracePath(WalkableTilesGrid grid, Node startNode, Node endNode)
        {
